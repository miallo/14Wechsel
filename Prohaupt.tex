...
Die zumeist verwendete ist die sinusförmige mit $U(t)=U_0\cdot\sin(\omega t)$.
...
\begin{align*}
	...
	R_\text{ges}&=(77.3 \pm 1.1)\,\si{\ohm}\qquad .
\end{align*}
\subsection{$RLC$-Serienschaltung}
\begin{figure}[!htb]
	\centering
...
Der Fit nach der theoretischen Kurve ermittelte so 
\begin{align*}
...
Aus der 
\begin{align*}
\omega_{R\text{ LC}}&=\frac{1}{\sqrt{LC}}\\
\sigma_{\omega_{R\text{ LC}}}&=\frac{\sqrt{\frac{\sigma_{L}^{2}}{L^{2}} + \frac{\sigma_{C}^{2}}{C^{2}}}}{2 \cdot \sqrt{C} \cdot \sqrt{L}}\\
